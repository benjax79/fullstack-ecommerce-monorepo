...
('Paleta de Sombras', 'Ojos', 'Nude', 20, 25000, 'Paleta con 12 tonos nude y ahumados', 'https://images.unsplash.com/photo-1598452963314-b09f397a5c48?w=400'),
...
('Polvo Compacto', 'Rostro', 'Transparente', 25, 15000, 'Polvo matificante fijador de maquillaje', 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400'),
('Corrector Ojeras', 'Rostro', 'Beige', 30, 11000, 'Corrector alta cobertura iluminador', 'https://images.unsplash.com/photo-1617897903246-719242758050?w=400'),
('Lápiz de Cejas', 'Cejas', 'Cafe', 60, 5500, 'Lápiz retráctil para definir cejas', 'https://images.unsplash.com/photo-1512496015851-a90fb38ba796?w=400'),
...
('Labial Líquido Mate', 'Labios', 'Rojo', 45, 9500, 'Labial líquido de larga duración 24hrs', 'https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=400'),
('Labial Cremoso', 'Labios', 'Rosa', 38, 7800, 'Labial hidratante con vitamina E', 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400'),
...
('Labial Metálico', 'Labios', 'Rosa', 30, 10500, 'Acabado metálico brillante', 'https://images.unsplash.com/photo-1619451334792-150fd785ee74?w=400'),
('Bálsamo Labial con Color', 'Labios', 'Rosa', 70, 5500, 'Hidratación con toque de color', 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=400'),
('Labial Satinado', 'Labios', 'Cafe', 42, 8800, 'Acabado satinado elegante', 'https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=400'),
('Tinta de Labios', 'Labios', 'Rojo', 55, 7200, 'Efecto natural de larga duración', 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400'),
('Labial Nude', 'Labios', 'Beige', 48, 8200, 'Tono natural para uso diario', 'https://images.unsplash.com/photo-1599948128020-9a44505b0d1b?w=400'),
('Set de Mini Labiales', 'Labios', 'Rojo', 25, 18500, 'Set de 5 tonos variados', 'https://images.unsplash.com/photo-1619451334792-150fd785ee74?w=400'),
('Labial Plumper', 'Labios', 'Rosa', 35, 11000, 'Efecto voluminizador instantáneo', 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=400'),
('Base Matte Full Coverage', 'Rostro', 'Beige', 28, 22000, 'Cobertura total acabado mate', 'https://images.unsplash.com/photo-1596755389378-c31d21fd1273?w=400'),
('Base Luminosa', 'Rostro', 'Beige', 32, 19500, 'Acabado luminoso natural', 'https://images.unsplash.com/photo-1631214524020-7e18db9a8f92?w=400'),
('BB Cream', 'Rostro', 'Beige', 50, 14000, 'Hidratación y cobertura ligera SPF30', 'https://images.unsplash.com/photo-1596755389378-c31d21fd1273?w=400'),
('CC Cream', 'Rostro', 'Beige', 45, 15500, 'Corrector de color con protección solar', 'https://images.unsplash.com/photo-1631214524020-7e18db9a8f92?w=400'),
('Contorno en Crema', 'Rostro', 'Dorado', 38, 12500, 'Contorno cremoso fácil de difuminar', 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400'),
('Contorno en Polvo', 'Rostro', 'Cafe', 40, 11000, 'Contorno en polvo natural', 'https://images.unsplash.com/photo-1567721913486-6585f069b332?w=400'),
('Bronzer', 'Rostro', 'Dorado', 35, 13500, 'Bronceador para efecto verano', 'https://images.unsplash.com/photo-1522338242992-e1a54906a8da?w=400'),
('Iluminador Líquido', 'Rostro', 'Dorado', 42, 14500, 'Iluminador fluido multiusos', 'https://images.unsplash.com/photo-1567721913486-6585f069b332?w=400'),
('Iluminador en Stick', 'Rostro', 'Blanco', 30, 12000, 'Aplicación precisa y fácil', 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400'),
('Rubor Líquido', 'Rostro', 'Rosa', 48, 9800, 'Acabado natural y fresco', 'https://images.unsplash.com/photo-1522338242992-e1a54906a8da?w=400'),
('Rubor en Crema', 'Rostro', 'Rojo', 36, 10200, 'Textura cremosa buildable', 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400'),
...
('Polvo Suelto', 'Rostro', 'Transparente', 40, 14000, 'Polvo fijador ultrafino', 'https://images.unsplash.com/photo-1631214524020-7e18db9a8f92?w=400'),
...
('Paleta Sombras Coloridas', 'Ojos', 'Rosa', 20, 32000, 'Paleta 24 tonos vibrantes', 'https://images.unsplash.com/photo-1583241800698-e8ab01830a07?w=400'),
('Sombra Individual Shimmer', 'Ojos', 'Dorado', 50, 6500, 'Sombra con brillo intenso', 'https://images.unsplash.com/photo-1598452963314-b09f397a5c48?w=400'),
('Sombra Individual Mate', 'Ojos', 'Cafe', 55, 6000, 'Sombra mate altamente pigmentada', 'https://images.unsplash.com/photo-1583241800698-e8ab01830a07?w=400'),
...
('Lápiz Kajal', 'Ojos', 'Negro', 60, 5500, 'Lápiz suave para línea de agua', 'https://images.unsplash.com/photo-1631730486572-226d1f595b68?w=400'),
...
('Glitter para Ojos', 'Ojos', 'Blanco', 30, 7000, 'Glitter cosmético seguro', 'https://images.unsplash.com/photo-1583241800698-e8ab01830a07?w=400'),
...
('Gel de Cejas con Color', 'Cejas', 'Cafe', 45, 7500, 'Define y rellena cejas', 'https://images.unsplash.com/photo-1597225244660-1cd128c64284?w=400'),
('Pomada de Cejas', 'Cejas', 'Cafe', 35, 9000, 'Pomada para cejas definidas', 'https://images.unsplash.com/photo-1597225244660-1cd128c64284?w=400'),
('Lápiz Microblading', 'Cejas', 'Dorado', 40, 8500, 'Efecto pelo a pelo', 'https://images.unsplash.com/photo-1597225244660-1cd128c64284?w=400'),
('Kit de Cejas', 'Cejas', 'Cafe', 25, 15000, 'Polvo, cera y pincel incluidos', 'https://images.unsplash.com/photo-1597225244660-1cd128c64284?w=400'),
...
('Esmalte Nude', 'Uñas', 'Rosa', 65, 4500, 'Tono natural elegante', 'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=400'),
...
('Set de Esmaltes', 'Uñas', 'Rojo', 30, 22000, 'Colección 6 tonos tendencia', 'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=400');
